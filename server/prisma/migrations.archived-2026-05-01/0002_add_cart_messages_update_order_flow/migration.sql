-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('ONLINE', 'IN_PERSON');

-- AlterEnum
ALTER TYPE "ListingStatus" ADD VALUE 'ON_HOLD';

-- AlterEnum
BEGIN;
CREATE TYPE "OrderStatus_new" AS ENUM ('PENDING_CONFIRMATION', 'CONFIRMED', 'COMPLETED', 'CANCELLED');
